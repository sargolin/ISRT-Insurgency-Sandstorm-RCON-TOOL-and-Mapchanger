...
## 1. Introduction
The first stage will be the minimum viable product so can see its basic functionality and have it working correctly, without any basic installation routine. I'll just pre-compile it and zip it up. IN the future I'll add more and more functionality described in the features list and also add a proper installation/deinstallation routine:

## 2. Features currently planned:
- Windows Installer
