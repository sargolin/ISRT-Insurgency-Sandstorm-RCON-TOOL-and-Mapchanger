...
- Debian 10.6 (working -> Ensure Python3, Pip, PyQt5 and X11 Lib is installed -> "sudo apt-get install python3 python3-pip libx11-xcb1 libqt5x11extras5" + "python3 -m pip install PyQt5")
