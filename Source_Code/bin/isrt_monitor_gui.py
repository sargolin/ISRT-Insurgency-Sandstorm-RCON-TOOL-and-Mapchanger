...
"selection-background-color: rgb(216, 216, 216);")
        ...
        self.btn_exec_overview_refresh_timer = QtWidgets.QPushButton(UI_Server_Monitor)
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
...
"color: rgb(255, 255, 255);")
        ...
        self.btn_exec_overview_refresh_timer.setObjectName("btn_exec_overview_refresh_timer")
        self.horizontalLayout.addWidget(self.btn_exec_overview_refresh_timer)
