...
"")
    ...
    def retranslateUi(self, rn_window):
        ...
        self.rn_top_layer.setText(_translate("rn_window", "<html><head/><body><p align=\"center\"><span style=\" font-size:16pt; font-weight:600;\">ISRT v0.8 Release Notes</span></p></body></html>"))
        self.rn_middle_layer.setText(_translate("rn_window", "<html><head/><body><p>Welcome to the version 0.8 January 2021 release with a lot of new features and changes. I would love, to hear from you via my Discord (=TCT= Madman#2803), my Steam Account (=TCT= Madman) or via e-mail (madman@isrt.info).</p><p align=\"center\">Report bugs or errors here:<a href=\"https://github.com/olli-e/ISRT-Insurgency-Sandstorm-RCON-Query-Tool/issues\"><span style=\" text-decoration: underline; color:#0000ff;\">Bug Tracker</span></a></p><p><span style=\" font-size:11pt; font-weight:600;\">What\'s new?</span></p><p>- Renamed a couple of items for better understanding<br/>- RCON commands are now automatically saved if not already in the history<br/>- Inserted Security/Insurgents DropDown Menu for selecting travel commands<br/>- Changed the Tell Map picture for better identification<br/>- Added rcon commands quit and exit as valid commands<br/>- Removed the automatic execution of custom commands on selection<br/>- Added DB Table View to Server Manager for easier overview<br/>- Discarded Night-View Maps, because you can\'t actually see anything in them<br/>- Re-Designed the server info box and a couple other GUI elements<br/>- Integrated Password Image display, removed the text display<br/>- Added DB Table View for online players directly on query execution<br/>- Aggregated the VAC/Ranked view<br/>- Implemented Threading for monitor to prevent app freeze<br/>- Added Maps Sheds, Stork_Castle_x Map, Frost, Temple, TORO and Bap<br/>- Changed the Mapchanger so the Scenarios are based on what the server provides<br/>- Removed the Side-Selector in the Mapchanger - now done by selecting the specific scenario.<br/>- Modified 127.0.0.1 handling to auto-switch to LAN IP, due to a Windows bug.<br/>- Removed auto-execution of commands selected from the Cutom Commands Dropdown menu<br/>- Added server monitor to view all saved servers in one table overview</p><p><span style=\" font-size:11pt; font-weight:600;\">Known bug </span><span style=\" font-size:11pt;\">(red = not possible to fix - NWI Server Bug):</span></p><p><span style=\" color:#aa0000;\">- When chosing random map change, the map is not updated correctly (NWI Server Bug reported; I unfortunately can\'t change false reporting on server side...)</span><br/></p><p align=\"center\"><span style=\" font-family:\'Consolas\',\'Courier New\',\'monospace\'; font-size:8pt; font-weight:600; color:#00557f;\">Thanks to Helsing and Stuermer for the pre-release testing - I appreciate that very much!</span><br/></p><p><br/></p></body></html>"))
