...
"")
    ...
    def retranslateUi(self, rn_window):
        ...
        self.rn_middle_layer.setText(_translate("rn_window", "<html><head/><body><p>Welcome to the version 0.8 January 2021. This time I had to do a lot of work behind the scenes adding the map manager and all new maps from the mapping contest. I hope you enjoy this release! I would love, to hear from you via my Discord (=TCT= Madman#2803), my Steam Account (=TCT= Madman) or via e-mail (madman@isrt.info).</p><p align=\"center\">Report bugs or errors here:<a href=\"https://github.com/olli-e/ISRT-Insurgency-Sandstorm-RCON-Query-Tool/issues\"><span style=\" text-decoration: underline; color:#0000ff;\">Bug Tracker</span></a></p><p align=\"center\"><br/></p><p><span style=\" font-size:11pt; font-weight:600;\">What\'s new?</span></p><p>- Implemented a <span style=\" font-weight:600;\">map manager</span> so users can add and modify maps and scenarios<br/>- Added <span style=\" font-weight:600;\">56 new maps</span>, especially from the mapping contest<br/>- Changed the <span style=\" font-weight:600;\">ISRT Server monitor to auto-refresh</span> all 30 seconds<br/>- No GUI freeze anymore due to proper threading<br/>- Re-Designed the help center<br/>- Added <span style=\" font-weight:600;\">Frenzy mode</span> switch to map changer<br/>- Commands can now be copied with double click in the Command history<br/>- Cleaned code and ressource file<br/></p><p><br/></p><p><span style=\" font-size:11pt; font-weight:600;\">Known bug </span><span style=\" font-size:11pt;\">(red = not possible to fix - NWI Server Bug):</span></p><p><span style=\" color:#aa0000;\">- When chosing random map change, the map is not updated correctly (NWI Server Bug reported; I unfortunately can\'t change false reporting on server side...)</span><br/></p><p align=\"center\"><span style=\" font-family:\'Consolas\',\'Courier New\',\'monospace\'; font-size:8pt; font-weight:600; color:#00557f;\">Thanks to Helsing, Stuermer and Mamba for the pre-release testing!</span></p><p align=\"center\"><span style=\" font-family:\'Consolas\',\'Courier New\',\'monospace\'; font-size:8pt; font-weight:600; color:#00557f;\">I appreciate that very much!</span><br/></p><p><br/></p></body></html>"))
