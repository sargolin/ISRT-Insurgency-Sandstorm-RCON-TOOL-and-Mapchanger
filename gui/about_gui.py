...
# Form implementation generated from reading ui file '.\source_files\about_gui_v0.5.ui'
#
...
class Ui_about_window(object):
    def setupUi(self, about_window):
        ...
        about_window.setMinimumSize(QtCore.QSize(360, 267))
        about_window.setMaximumSize(QtCore.QSize(360, 267))
        font = QtGui.QFont()
        ...
        self.btn_about_close.setStyleSheet("background-color:rgb(228, 228, 228)\n"
"")
    ...
    def retranslateUi(self, about_window):
        ...
        self.aboutbody.setText(_translate("about_window", "<html><head/><body><p align=\"center\"><span style=\" font-size:12pt; font-weight:600;\">ISRT v0.5</span></p><p align=\"center\">Insurgency Sandstorm RCON/Query Tool</p><p align=\"center\">Created by Madman</p><p align=\"center\">Support: <a href=\"mailto:isrt@edelmeier.org\"><span style=\" text-decoration: underline; color:#0000ff;\">isrt@edelmeier.org</span></a></p><p align=\"center\"><a href=\"https://github.com/sargolin/ISRT-Insurgency-Sandstorm-RCON-TOOL-and-Mapchanger\"><span style=\" text-decoration: underline; color:#0000ff;\">GitHub</span></a></p><p align=\"center\">GNU/Public License Software </p></body></html>"))
