...
"")
    ...
    def retranslateUi(self, about_window):
        ...
        self.aboutbody.setText(_translate("about_window", "<html><head/><body><p align=\"center\"><span style=\" font-size:12pt; font-weight:600;\">ISRT v0.6</span></p><p align=\"center\">Insurgency Sandstorm RCON/Query Tool</p><p align=\"center\">Created by Madman</p><p align=\"center\">Support: <a href=\"mailto:isrt@edelmeier.org\"><span style=\" text-decoration: underline; color:#0000ff;\">isrt@edelmeier.org</span></a></p><p align=\"center\"><a href=\"https://github.com/sargolin/ISRT-Insurgency-Sandstorm-RCON-TOOL-and-Mapchanger\"><span style=\" text-decoration: underline; color:#0000ff;\">GitHub</span></a></p><p align=\"center\">GNU/Public License Software </p></body></html>"))
